	...
	<td>
		...
		<p class="description">
			...
			if ( IS_PROFILE_PAGE ) {
				...
				/*$description =  sprintf(
					__( '<a href="%s">You can change your profile Hero picture on Mosha Online</a>.' ),
					__( 'https://moshaonline.com/' )
				);*/
				/* Mosha Online: Avatars */
				$description =  sprintf(
					__( '<a href="%s" target="_blank">You can change your profile Hero picture on Mosha Online</a>.' ),
					__( 'https://moshaonline.com/' )
				);
			} else {
				$description = '';
